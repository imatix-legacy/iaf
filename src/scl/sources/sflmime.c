...
/*  ---------------------------------------------------------------------[<]-
    ...
    byte longer than the amount of data in the source buffer.  The base64
    data consists of portable printable characters as defined in RFC 1521.
    Returns the number of bytes output into the target buffer, NOT including
    the NULL terminator.
    ---------------------------------------------------------------------[>]-*/
                      ...
                      const char *charset)
{
    ...
    encoded_length = (short)((double)source_length * 1.5);
