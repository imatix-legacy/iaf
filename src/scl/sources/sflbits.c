...
/*  ---------------------------------------------------------------------[<]-
    ...
    Synopsis: Writes the bitstring to a allocated memory stream. To read
    the bitstring, use the bits_load() function.  Return NULL if fail.
    The buffer is base64 encoded.
    The returned buffer must be free by mem_free () function.
    ---------------------------------------------------------------------[>]-*/
    ...
    if (buffer)
      {
        ...
        *((dbyte *)position) = bits-> free_list;
        ...
        encoded = mem_alloc ((long)((double)size * 1.5));
        if (encoded)
...
/*  ---------------------------------------------------------------------[<]-
    ...
    Synopsis: Reads a bitstring from the specified memory stream.  You must
    have previously written the bitstring using bits_save ().  Returns a
    newly-created bitmap, or NULL if there was insufficient memory.
    ---------------------------------------------------------------------[>]-*/
...
/*  ---------------------------------------------------------------------[<]-
    ...
    Synopsis: Apply a logical AND between two bitsting and return the result.
    ---------------------------------------------------------------------[>]-*/
...
/*  ---------------------------------------------------------------------[<]-
    ...
    Synopsis: Apply a logical OR between two bitsting and return the result.
    ---------------------------------------------------------------------[>]-*/
...
/*  ---------------------------------------------------------------------[<]-
    ...
    Synopsis: Apply a logical XOR between two bitsting and return the result.
    ---------------------------------------------------------------------[>]-*/
